...
function loaded(league,thispage,p){
	...
	$.getJSON("json/ft_2_4.php?leaguename="+league+"&CurrPage="+thispage+"&callback=?",function(json){
...
$(document).ready(function(){
	$("#xzls").click(function(){ //选择联赛
		JqueryDialog.Open('足球早餐波胆', 'json/dialog.php?lsm='+window_lsm, 600, window_hight);
	});
});