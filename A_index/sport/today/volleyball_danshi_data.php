...
$sql		=	"select id from volleyball_match WHERE Match_Type=1 AND Match_CoverDate>now() AND Match_Date='".date("m-d")."' ".$sqlwhere.' order by Match_CoverDate,match_name';//print_r($sql);exit;
