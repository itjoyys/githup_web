...
$sql		=	"select id from baseball_match WHERE Match_Type=1 and Match_CoverDate>now() and Match_Date='".date("m-d")."' ".$sqlwhere.' order by Match_CoverDate,match_name';//print_r($sql);exit;
