...
<script language="javascript" src="volleyball_bodan.js" ></script>
<script language="javascript" src="../style/js/volleyball_match.js"></script>
...
function chg_league() {
	...
	try {
			...
			legFrame.location.href = "chuangkous.php?lsm=volleyball_bodan";
		...
		//legFrame.location.href = "chuangkous.php?uid=" + parent.uid + "&rtype=" + parent.rtype + "&langx=" + parent.langx + "&mtype=" + parent.ltype;
			...
			//JqueryDialog.Open('足球单式', 'dialog.php?lsm='+window_lsm, 600, window_hight);
			legFrame.src = "chuangkous.php?lsm=volleyball_bodan";
	...
	reload_var("");
          ...
          <table  id="game_table"  cellspacing="0"  cellpadding="0"  class="game">
           <tr>
			  ...
			  <th  class="time">赛事</th>
			  <th class="h_r">3:0</th>
              <th  class="h_ou">3:1</th>
              <th  class="h_oe">3:2</th>
         ...
         <tbody  id="datashow">		 
		  ...
		  <tr><td  colspan="5" align="center" style="background:#fff;">正在加载数据...</td></tr>
