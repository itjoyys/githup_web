...
$sql		=	"select id from lq_match WHERE  Match_Type!=2 AND  Match_CoverDate>'".date('Y-m-d H:i:s')."' AND Match_Date='".date("m-d")."' ".$sqlwhere.'  order by Match_CoverDate,iPage,iSn,Match_ID,match_name,Match_Master';
