...
<script language="javascript" src="volleyball_danshi.js" ></script>
...
function chg_league() {
	...
	try {
			...
			legFrame.location.href = "chuangkous.php?lsm=volleyball_danshi";
		...
		//legFrame.location.href = "chuangkous.php?uid=" + parent.uid + "&rtype=" + parent.rtype + "&langx=" + parent.langx + "&mtype=" + parent.ltype;
			...
			//JqueryDialog.Open('足球单式', 'dialog.php?lsm='+window_lsm, 600, window_hight);
			legFrame.src = "chuangkous.php?lsm=volleyball_danshi";
