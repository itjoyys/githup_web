...
$dbpath=dirname(__FILE__).'/../../include/database.php';
if(!file_exists($dbpath)) exit('DataBase Not Find!');
else include_once $dbpath;
$_DBCPUB=$_DBC['public'];
$_DBCPRI=$_DBC['private'];
/*

$PUBLIC=MDOO($_DBCPUB);
$data = $PUBLIC->select("bet_match", ["match_date","id"], ["ID[>]" => 100,"LIMIT"=>[10,100]]);
$PUBLIC->log();
echo $PUBLIC->last_query();
print_r($data);*/
?>