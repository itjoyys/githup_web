...
$sql		=	"select id from volleyball_match where Match_Type=10 and Match_CoverDate>DATE_ADD(now(),INTERVAL -12 HOUR) ".$sqlwhere.' order by Match_CoverDate,match_name';
