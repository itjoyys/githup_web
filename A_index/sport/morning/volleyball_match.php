		...
		<tr>
			<td>
				<table  border="0"  cellpadding="0"  cellspacing="0"  id="box">
				    <tbody>
					<tr>
						<td  class="top"><h1><em>排球结果</em><span  class="maxbet">单注最高派彩额：  500000</span>
						</h1></td>
					</tr>
					<tr>
						<td  class="mem">
...
?>
		  <tr  id="TR_01-1870256"    *class*="">
			...
			<? }else{?>
				<td  class="b_cen"  id="118389861_MH"><?=$rows["MB_Inball"]?></td>
		  ...
		  <? }else{?>
			<td  class="b_cen"  id="118389861_MC"><?=$rows["TG_Inball"] ?></td>
