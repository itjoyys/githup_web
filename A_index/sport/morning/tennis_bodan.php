...
<script language="javascript" src="tennis_bodan.js" ></script>
...
function chg_league() {
	...
	try {
			...
			legFrame.location.href = "chuangkous.php?lsm=tennis_bodan";
		...
		//legFrame.location.href = "chuangkous.php?uid=" + parent.uid + "&rtype=" + parent.rtype + "&langx=" + parent.langx + "&mtype=" + parent.ltype;
			...
			//JqueryDialog.Open('足球单式', 'dialog.php?lsm='+window_lsm, 600, window_hight);
			legFrame.src = "chuangkous.php?lsm=tennis_bodan";
		}
	...
	reload_var("");
          ...
          <table  id="game_table"  cellspacing="0"  cellpadding="0"  class="game">
           <tr>
			  ...
			  <th class="h_r">2:1</th>
              <th  class="h_ou">3:0</th>
              <th  class="h_oe">3:1</th>
