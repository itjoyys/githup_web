...
$sql		=	"select id from volleyball_match WHERE Match_Type=1 AND Match_CoverDate>DATE_ADD(now(),INTERVAL -12 HOUR) AND Match_Date>'".date("m-d",strtotime("-12 hours"))."' ".$sqlwhere.' order by Match_CoverDate,match_name';//print_r($sql);exit;
