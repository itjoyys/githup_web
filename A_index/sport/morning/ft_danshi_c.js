...
function loaded(league,thispage,p){
    ...
    $.getJSON("ft_danshi_data.php?action=c&leaguename="+league+"&CurrPage="+thispage+"&callback=?",function(json){
