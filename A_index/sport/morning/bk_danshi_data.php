...
$sql		=	"select id from lq_match WHERE Match_Type=0 AND Match_CoverDate>now() AND Match_Date<>'".date("m-d")."' ".$sqlwhere.'  order by Match_CoverDate,iPage,iSn,Match_ID,match_name,Match_Master';
