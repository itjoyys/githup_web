...
$sql .=" and (notice_cate='4' or notice_cate='2')";
$sql .=" and notice_date>'$date'";
$sql .= " ORDER BY notice_date DESC limit 0,8";
$notice=M('site_notice',$db_config);
$data = $notice->where($sql)->select();
?>
        ...
        <div id="MAMain" style="width:767px">
            <div id="MACenter-content">
                <div id="MACenterContent">
                    <div id="MNav">
                        <span class="mbtn">体育公告</span>
                        <div class="navSeparate"></div>
                        <a  target="k_memr" class="mbtn" href="tv_news.php">视讯公告</a>
                        <div class="navSeparate"></div>
                        <a  target="k_memr" class="mbtn" href="lottery_news.php">彩票公告</a>
                    </div>
                    <div id="MMainData">
                        <h2 class="MSubTitle">体育公告</h2>
                        <table class="MMain" border="1">
                            ...
                            <tbody>
                                ...
                                <tr class="MColor1" align="center">
                                    <td class="mouseenter"><?=$v['notice_date']?></td>
                                    <td class="MContent mouseenter"><?=$v['notice_content']?></td>
                                </tr>
                                <?}}else{?>
