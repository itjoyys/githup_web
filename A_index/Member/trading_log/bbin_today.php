                ...
                <div id="MACenterContent">
                    ...
                    <div id="MMainData" style="overflow-y:scroll; height:330px;overflow-x:hidden">
                        <div class="MControlNav">
                            <input type="hidden" id="Company" value="bbin">
        ...
        success: function(msg){
            if(msg.data['Code']==10022){
                ...
                html+='<tr class="m_title">' +
                    ...
                    /*'<td>'+ v.GameResult+'</td>' +*/
                    '<td>'+ v.BetType+'</td>' +
                    '<td>'+ parseFloat(v.BetMoney).toFixed(4)+'</td>' +
                    '<td>'+ parseFloat(v.ValidBetMoney).toFixed(4)+'</td>' +
                    '<td>'+ parseFloat(v.ResultMoney).toFixed(4)+'</td>' +
                    '</tr>';
                })
                ...
                $('#page').html(PageHtml);
                $('#ListData').html(html);
                $('#BetMoneyAll').html(parseFloat(msg.data['BetMoneyAll']).toFixed(4));
                $('#ValidBetMoneyAll').html(parseFloat(msg.data['ValidBetMoneyAll']).toFixed(4));
                $('#ResultMoneyAll').html(parseFloat(msg.data['ResultMoneyAll']).toFixed(4));
                $('#BetMoneyAll_').html(parseFloat(msg.data['BetMoneyAll_']).toFixed(4));
                $('#ValidBetMoneyAll_').html(parseFloat(msg.data['ValidBetMoneyAll_']).toFixed(4));
                $('#ResultMoneyAll_').html(parseFloat(msg.data['ResultMoneyAll_']).toFixed(4));
