                ...
                <div id="MACenterContent">
                    ...
                    <div id="MMainData" style="overflow-y:scroll; height:330px;overflow-x:hidden">
                        <div class="MControlNav">
                            <input type="hidden" id="Company" value="mg">
                            <input type="hidden" id="gametype" value="all">
...
function GetVideoList(){
    ...
    var s_time=$('#s_time').val()+' 00:00:00';
    var e_time=$('#e_time').val()+' 23:59:59';
    var username=$('#username').val()
    var page_num=$('#page_num').val()
    var Page=$('#page :selected').val()
    var OrderId=$('#OrderId').val()
    var request = 'OrderId='+OrderId+'&g_type='+Company+'&gametype='+gametype+'&S_Time='+s_time+'&E_Time='+e_time+'&UserName='+username+'&Page_Num='+page_num+'&Page='+Page;
    $.ajax({
        type: "GET",
