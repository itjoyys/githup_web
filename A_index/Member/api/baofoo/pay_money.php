...
#copyright{ float:left; width:380px; margin:5px 0 0 10px; color:#FFF; font-family:Verdana, Geneva, sans-serif; font-size:10px}
    ...
    <body>
            ...
            <div id="main">
                ...
                <div id="data">
	<form id="frm_payment" action="pay.php" method="post" class="democss" target="_top">  
          
            <input type="hidden" name="PayID" value="<?=$_POST['bank']  ?>">
            <input type="hidden" name="TransID" value="<?=$_POST['order_num']?>">
            <input type="hidden" name="TradeDate" value="<?=date('YmdHis')?>">
            <input type="hidden" name="OrderMoney" value="<?=$_POST['s_amount']?>">
            <input type="hidden" name="Amount" value="1">
            <input type="hidden" name="Username" value="<?=$userinfo['username']?>">
            <input type="hidden" name="AdditionalInfo" value="">
            <input type="hidden" name="NoticeType" value="1">
            <input type="hidden" name="pay_id" value="<?=$_SESSION['payid']?>">
        ...
        <input type="submit" value="确定送出" onclick="document.form2.submit();" class="za_button">
     </form>
