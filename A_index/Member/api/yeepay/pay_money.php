...
#copyright{ float:left; width:380px; margin:5px 0 0 10px; color:#FFF; font-family:Verdana, Geneva, sans-serif; font-size:10px}
    ...
    <body>
            ...
            <div id="main">
                ...
                <div id="data">
	<form id="frm_payment" action="req.php" method="post" class="democss" target="_top">  
     
            <input type="hidden" name="p2_Order" value="<?=$_POST['order_num']?>" />
            <input type="hidden" name="p3_Amt" value="<?=$_POST['s_amount']?>" />
            <input type="hidden" name="pd_FrpId" value="<?=$_POST['pd_FrpId']?>" />
