    ...
    public function get_user_audit(){
       ...
       foreach ($audit_all as $key => $v) {
       	...
       	//  $at_allbet = 0;
       	  ...
       	  //视讯打码
       	  $g_type_arr = array("og","ag","mg","ct","bbin","lebo",'mgdz','bbdz');
       	  $dateArr = array($v['begin_date'],$v['end_date']);
       	  $VideoBet = array();
          $VideoBet = userBet::userVideoBet($v['username'],$dateArr,$g_type_arr);
         // return $VideoBet;
