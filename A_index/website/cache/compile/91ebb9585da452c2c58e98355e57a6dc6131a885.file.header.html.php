<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-29 04:13:06
         compiled from "/home/wwwuser/public_html/t/website/templates/header.html" */ ?>
<?php /*%%SmartyHeaderCode:15754486415590fe12b32091-62897080%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '91ebb9585da452c2c58e98355e57a6dc6131a885' => 
    array (
      0 => '/home/wwwuser/public_html/t/website/templates/header.html',
      1 => 1434832531,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15754486415590fe12b32091-62897080',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5590fe12bd1c51_09213358',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5590fe12bd1c51_09213358')) {function content_5590fe12bd1c51_09213358($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config("public.conf", $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars("public", 'local'); ?>
...
>
<style>
.hide{ width:174px; height:30px; z-index:1; float:left; position:relative; left:420px; top:-105px;}
...
/index/logo.png" width="310" height="184" /></span>
      ...
      <div id="L-Sub" class="hide">
        <div class="game-ball" id="hide-2"  style="display:none; margin-left:5px; ">
              <ul class="select">
                  <li class="hover_a"><a href="./index.php?a=egame" target="mem_index" style=" text-decoration:none;">MG电子</a></li>
                  <li class="hover_a"><a  href="javascript:;" <?php if (empty($_smarty_tpl->tpl_vars['uid']->value)) {?>onclick="alert('您尚未登录，请先登录再进行游戏!')"<?php } else { ?>onclick="opengeme('/video/games/login.php?g_type=ag')"<?php }?> target="mem_index" style=" text-decoration:none;">AG电子</a></li>
                  <li class="hover_a"><a onclick="alert('尚未开通')" target="mem_index" style=" text-decoration:none;">BBIN电子</a></li>
              </ul>
      </div>
    </div> 
      </div> 
...
<style>
.Customer{ position:fixed;right:2px; top:10%; width:120px; height:460px;  z-index:99999;}
