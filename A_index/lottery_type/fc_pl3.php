...
$style = 'pl_3';
if (!empty($_GET['type'])) {
    $fc_pl3_odds = M('c_odds_6',$db_config)->where("type='".$_GET['type']."'")->find();
	 // p($fc_pl3_odds);
    switch ($_GET['type']) {
        case 'ball_1':
            $title_3d = '第一球';
...
<script src="public/js/fc_pl3_order.js" type="text/javascript"></script>
...
<body marginwidth="3" marginheight="3" id="HOP"
	...
	<div id="fc_type" style="display: none">6</div>
	<div id="kq_box_001" style="display: none;">
		<div id="kq_box_num" style="margin: 50px auto 0">
			距离 第 <b><font color="#7c3838"><?=dq_qishu(6,$publicdb);?></font></b> 期 开盘时间还有：<font color="#7AFF00"><strong><span
...
if (strtotime($array['c_time']) > strtotime($array['o_state']) && strtotime($array['c_time']) < strtotime($array['f_state'])) {
 ...
 ?>
  ...
  <script type="text/javascript">
	...
	setInterval(function(){lottery(6,3,<?=$num['qishu']?>);},30000);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<table border="0" cellpadding="0" cellspacing="1" class="game_table">
			<tbody>
				<tr class="tbtitle">
					<td colspan="15" id="time_td"><font>当前期数：<font class="colorDate"><b><?=dq_qishu(6,$publicdb);?></b></font>
				...
				<form autocomplete="off" name="orders" id="order_form" method="get"
					...
					<input type="hidden" name="type" value="6"> <input type="hidden"
						name="qishu"
						value="<?=dq_qishu(6,$publicdb);?>">
					<tr class="tbtitle2">
						<th colspan="15"><div
  ...
  <?php if ($_GET['type'] ==='ball_1' || $_GET['type'] ==='ball_2' || $_GET['type'] ==='ball_3' || $_GET['type'] === 'ball_6' || $_GET['type'] === 'ball_7'){
		if($_GET['type'] === 'ball_6'){
			$tabb=$ball;
		}else{
			$tabb=1;
  ...
  ?>
    <tr>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h1"><?=$fc_pl3_odds['h1']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h2"><?=$fc_pl3_odds['h2']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h3"><?=$fc_pl3_odds['h3']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h4"><?=$fc_pl3_odds['h4']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h5"><?=$fc_pl3_odds['h5']?></span></td>
					...
					<tr>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h6"><?=$fc_pl3_odds['h6']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h7"><?=$fc_pl3_odds['h7']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h8"><?=$fc_pl3_odds['h8']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h9"><?=$fc_pl3_odds['h9']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$tabb?>_h10"><?=$fc_pl3_odds['h10']?></span></td>
    ...
    <!-- 龙虎和 -->
					<tr class="tbtitle">
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$ball?>_h1"><?=$fc_pl3_odds['h1']?></span></td>
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$ball?>_h2"><?=$fc_pl3_odds['h2']?></span></td>
						<td class="ball_ff"><input class="inp1" type="text" js='js'
							style="height: 18px" class="input1" size="4"
							id="ball_<?=$ball?>_2" name="ball_<?=$ball?>_2"></td>

						<td class="ball_bg" align="center" valign="middle">对子</td>
						<td class="ball_ff"><span rate="true" id="ball_<?=$ball?>_h3"><?=$fc_pl3_odds['h3']?></span></td>
						<td class="ball_ff"><input class="inp1" type="text" js='js'
							style="height: 18px" class="input1" size="4"
							id="ball_<?=$ball?>_3" name="ball_<?=$ball?>_3"></td>

						<td class="ball_bg" align="center" valign="middle">半顺</td>
						<td class="ball_ff"><span rate="true" id="ball_<?=$ball?>_h4"><?=$fc_pl3_odds['h4']?></span></td>
						<td class="ball_ff"><input class="inp1" type="text" js='js'
							style="height: 18px" class="input1" size="4"
							id="ball_<?=$ball?>_4" name="ball_<?=$ball?>_4"></td>

						<td class="ball_bg" align="center" valign="middle">杂六</td>
						<td class="ball_ff"><span rate="true" id="ball_<?=$ball?>_h5"><?=$fc_pl3_odds['h5']?></span></td>
						<td class="ball_ff"><input class="inp1" type="text" js='js'
							style="height: 18px" class="input1" size="4"
							id="ball_<?=$ball?>_5" name="ball_<?=$ball?>_5"></td>
					</tr>
    ...
    <!-- 龙虎和 -->
					...
					<tr class="tbtitle">
						...
						<td class="ball_ff"><span rate="true" id="ball_<?=$ball?>_h6"><?=$fc_pl3_odds['h6']?></span></td>
						<td class="ball_ff"><input class="inp1" type="text" js='js'
							style="height: 18px" class="input1" size="4"
							id="ball_<?=$ball?>_6" name="ball_<?=$ball?>_6"></td>

						<td class="ball_bg" align="center" valign="middle">和</td>
						<td class="ball_ff"><span rate="true" id="ball_<?=$ball?>_h7"><?=$fc_pl3_odds['h7']?></span></td>
						<td class="ball_ff"><input class="inp1" type="text" js='js'
							style="height: 18px" class="input1" size="4"
							id="ball_<?=$ball?>_7" name="ball_<?=$ball?>_7"></td>
  ...
  <?php if ($_GET['type'] ==='ball_1' || $_GET['type'] ==='ball_2' || $_GET['type'] ==='ball_3') {
?>

					<tr>
						<td class="ball_bg">大</td>
						<td class="ball_ff"><span rate="true" id="ball_1_h11"><?=$fc_pl3_odds['h11']?></span></td>
						<td class="ball_ff"><input pid="0" num="0" class="inp1"
							type="text" js='js' style="height: 18px" class="input1" size="4"
						...
						<td class="ball_ff"><span rate="true" id="ball_1_h12"><?=$fc_pl3_odds['h12']?></span></td>
						<td class="ball_ff"><input pid="0" num="0" class="inp1"
							type="text" js='js' style="height: 18px" class="input1" size="4"
						...
						<td class="ball_ff"><span rate="true" id="ball_1_h13"><?=$fc_pl3_odds['h13']?></span></td>
						<td class="ball_ff"><input pid="0" num="0" class="inp1"
							type="text" js='js' style="height: 18px" class="input1" size="4"
						...
						<td class="ball_ff"><span rate="true" id="ball_1_h14"><?=$fc_pl3_odds['h14']?></span></td>
						<td class="ball_ff"><input pid="0" num="0" class="inp1"
							type="text" js='js' style="height: 18px" class="input1" size="4"
...
<?php
include ("../include/public_config.php");
$result = M("c_auto_6",$db_config)->field("*")->order("qishu desc")->limit("0,30")->select();
...
<?php }} ?>
		...
		<iframe src="./show_zoushi.php?type=6" width="100%" height="150"
