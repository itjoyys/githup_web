...
$style = 'jl_k3';
if (! empty ( $_GET ['type'] )) {
	$fc_3d_odds = M ( 'c_odds_14', $db_config )->where ( "type='" . $_GET ['type'] . "'" )->find ();
...
<body marginwidth="3" marginheight="3" id="HOP"
	...
	<div id="fc_type" style="display: none">14</div>
...
<script type="text/javascript">
	...
	setInterval(function(){lottery(14,3,<?=$num['qishu']?>);},30000);
...
<table border="0" cellpadding="0" cellspacing="1" class="game_table">
			<tbody>
				<tr class="tbtitle">
					<td colspan="15" id="time_td"><font>当前期数：<font class="colorDate"><b><?php echo dq_qishu(14,$publicdb); ?></b></font>
				...
				<form autocomplete="off" name="orders" id="order_form" method="get"
					...
					<input type="hidden" name="type" value="14"> <input type="hidden"
						name="qishu" value="<?=dq_qishu(14,$publicdb);?>">
					<tr class="tbtitle2">
