...
<? 
if ($_GET['class2']==""){echo "<script>alert('非法进入!');parent.parent.leftFrame.location.href='liuhecai.php?action=k_tm';window.location.href='liuhecai.php?action=k_tm';</script>"; 
// exit;
...
if(window.location.host!=top.location.host){top.location=window.location;} 
 ...
 -->
<SCRIPT language=javascript>
window.setTimeout("self.location='<?=$urlurl ?>'", 90000);
</SCRIPT>
<SCRIPT language=JAVASCRIPT>
// if(self == top){location = '/';}
...
<body>
<div id="n1_table" style="display:none;">
										  
<TABLE border=0 cellSpacing=0 cellPadding=0 width=180 class="Tab_backdrop">
  <TBODY>
  <TR>
    <TD class="Left_Place"  vAlign=top align=center>
        
<form action="liuhecai.php?action=k_tansave&class2=<?=$_GET['class2']?>" method="post" name="form1" id="form1" >    										  
<TABLE class=t_list cellSpacing=1 cellPadding=0 width=180 border=0>
    <tr class="left_acc_out_top">
      <td height="30" align="center"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
        <tr>
          <td height="25" colspan="4" align="center"  style="LINE-HEIGHT: 23px; color:#fff" bgcolor="#504a16">确认注单</td>
        </tr>
        <tr class="left_acc_out_top">
...
// $result2=$mysqli->query("Select SUM(sum_m) As sum_m55 from c_odds_7 where Kithe='".$Current_Kithe_Num."' and  class1='".ka_bl($rate_id,"class1")."' and  class2='".ka_bl($rate_id,"class2")."' and class3='".ka_bl($rate_id,"class3")."' "); 
...
// echo "<script Language=Javascript>alert('对不起，[".ka_bl($rate_id,"class3")."号]暂停下注.请反回重新选择!');parent.parent.leftFrame.location.href='".$urlurl."';window.location.href='".$urlurl."';</script>";
// // exit;
// }
}
...
// exit;
			  ...
			  ?>
			   ...
			   <tr>
          <td height="28" colspan="4" align="center" bordercolor="#cccccc" bgcolor="ffffff" style="LINE-HEIGHT: 23px"><input  class="button_a" onClick="self.location='<?=$urlurl ?>';" type="button" value="放弃" name="btnCancel" />
        &nbsp;&nbsp;
        <!-- onClick="return ChkSubmit();" -->
        <input  class="button_a"  type="submit" value="确定"  name="btnSubmit" /></td>
          </tr>
