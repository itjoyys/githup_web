...
<tr class="hset">
    <td class="tbtitle4" nowrap="nowrap" id="time_tm" colspan="15">
        <button  style="height: 22;background-color:<?=$z1color?>" class="button_b" onclick="javascript:self.location.href='liuhecai.php?action=k_zt&ids=正1特';"><img width="16" height="16" align="absmiddle" src="public/images/add.gif?=">正1特</button>
        <button ;="" style="height: 22;background-color:<?=$z2color?>" class="button_a" onclick="javascript:location.href='liuhecai.php?action=k_zt&ids=正2特';"><img width="16" height="16" align="absmiddle" src="public/images/add.gif?=">正2特</button>
        <button ;="" style="height: 22;background-color:<?=$z3color?>" class="button_a" onclick="javascript:location.href='liuhecai.php?action=k_zt&ids=正3特';"><img width="16" height="16" align="absmiddle" src="public/images/add.gif?=">正3特</button>
        <button ;="" style="height: 22;background-color:<?=$z4color?>" class="button_a" onclick="javascript:location.href='liuhecai.php?action=k_zt&ids=正4特';"><img width="16" height="16" align="absmiddle" src="public/images/add.gif?=">正4特</button>
        <button ;="" style="height: 22;background-color:<?=$z5color?>" class="button_a" onclick="javascript:location.href='liuhecai.php?action=k_zt&ids=正5特';"><img width="16" height="16" align="absmiddle" src="public/images/add.gif?=">正5特</button>
        <button ;="" style="height: 22;background-color:<?=$z6color?>" class="button_a" onclick="javascript:location.href='liuhecai.php?action=k_zt&ids=正6特';"><img width="16" height="16" align="absmiddle" src="public/images/add.gif?=">正6特</button>
      </td>
  </tr>
<form  name="lt_form"  method="get" action="main_left.php" style="height:580px;" target="k_meml"  onsubmit="return ChkSubmit();">
<input type="hidden" name="title_3d" value="正特" id="title_3d">
...
<TABLE cellSpacing=1 cellPadding=0 style="width:780px" border=0 class="game_table all_body" >  
<!--   <tr class="tbtitle2">
    <th colspan="15"><div  style="float:left;line-height:30px;text-align:center;width:100%">正特</div>
  </tr>  --> 
   <tr class="tbtitle2">
    <td>号码</td>
    <td>赔率</td>
    ...
    <tr class="tbtitle">
      ...
      <td width="51" height="25" align="center" valign="middle" bgcolor="#ffffff" class="ball_ff"><b><span rate="true1" id="bl00"><?=$data_bet['0']['rate'] ?></span></b></td>
      <td width="60" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><input onKeyPress="return CheckKey();" 
      ...
      <td width="51" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span rate="true1" id=bl10> <?=$data_bet['10']['rate'] ?></span></b></td>
      <td width="60" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><input  onKeyPress="return CheckKey();" 
      ...
      <td width="51" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span rate="true1" id=bl20><?=$data_bet['20']['rate'] ?></span></b></td>
      <td width="60" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><input 
      ...
      <td width="51" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span rate="true1" id=bl30> <?=$data_bet['30']['rate'] ?></span></b></td>
      <td width="60" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><input 
			  onKeyPress="return CheckKey();" 
     ...
     <!--      <input name="gb31" type="hidden"  value="0">
      ...
      <td width="51" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span rate="true1" id=bl40> <?=$data_bet['40']['rate'] ?></span></b></td>
      <td width="60" height="25" align="center" bgcolor="#ffffff" class="ball_ff"><input 
			  onKeyPress="return CheckKey();" 
    ...
    <tr class="tbtitle">
      ...
      <td height="25" colspan="3" align="center" class="ball_ff" bgcolor="#ffffff"><table border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
...
<!--  <tr class="tbtitle">
      ...
      <TD height="25" class="ball_ff_h" width=78>单</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl49><?=$data_bet['49']['rate'] ?></span></b></TD>
     ...
     <TD  class="ball_ff_h" width=78>双</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl50><?=$data_bet['50']['rate'] ?></span></b></TD>
          <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        onKeyPress="return CheckKey();" 
      ...
      <TD class="ball_ff_h"  width=78 style="color:#f00;">红　波</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl55><?=$data_bet['55']['rate'] ?></span></b></TD>
          <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        onKeyPress="return CheckKey();" 
                        onBlur="this.className='inp1';return CountGold(this,'blur','sb','<?=ka_kk1("红波")?>');" 
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="this.className='inp1m';CountGold(this,'focus');;" 
      style="HEIGHT: 18px"  class="" size="3" type='text' js='js' name="Num_56" id="Num_56" />
          <input name="gb56" type="hidden"  value="0">
          <input name="class3_56" value="红波" type="hidden" ></TD>
     

     <TD class="ball_ff_h" width=78>大</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl51><?=$data_bet['51']['rate'] ?></span></b></TD>
          <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        onKeyPress="return CheckKey();" 
   ...
   <TD class="ball_ff_h" width=78>小</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl52><?=$data_bet['52']['rate'] ?></span></b></TD>
          <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        onKeyPress="return CheckKey();" 
     ...
     <!-- <tr class="tbtitle">
       ...
       <TD height="25" class="ball_ff_h" width=78 style="color:blue;">蓝　波</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl57><?=$data_bet['57']['rate'] ?></span></b></TD>
          <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        onKeyPress="return CheckKey();" 
     ...
     <TD class="ball_ff_h" width=78>合数单</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl53><?=$data_bet['53']['rate'] ?></span></b></TD>
          <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        ...
        onKeyPress="return CheckKey();" 
                        ...
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="this.className='inp1m';CountGold(this,'focus');;" 
      style="HEIGHT: 18px"  class="" size="3" type='text' js='js' name="Num_54" id="Num_54" />
          <input name="gb54" type="hidden"  value="0">
          <input name="class3_54" value="合单" type="hidden" ></TD>
     

     <TD class="ball_ff_h" width=78>合数双</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl54><?=$data_bet['54']['rate'] ?></span></b></TD>
          <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        ...
        onKeyPress="return CheckKey();" 
                        ...
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="this.className='inp1m';CountGold(this,'focus');;" 
      style="HEIGHT: 18px"  class="" size="3" type='text' js='js' name="Num_55" id="Num_55" />
     ...
     <TD class="ball_ff_h" width=78>大</TD>
      ...
      style="HEIGHT: 18px"  class="" size="3" type='text' js='js' name="Num_52" id="Num_52" />
        ...
        <TD class="ball_ff_h" width=78 style="color:green;">绿　波</TD>
          <TD  width=77 class="ball_ff"><b><span rate="true1" id=bl56><?=$data_bet['56']['rate'] ?> 
    <TD  width=78  bgcolor="#FFFFFF" class="ball_ff"><input 
        onKeyPress="return CheckKey();" 
                        onBlur="this.className='inp1';return CountGold(this,'blur','sb','<?=ka_kk1("绿波")?>');" 
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="this.className='inp1m';CountGold(this,'focus');;" 
      style="HEIGHT: 18px"  class="" size="3" type='text' js='js' name="Num_57"  id="Num_57" />
          <input name="gb57" type="hidden"  value="0">
          <input name="class3_57" value="绿波" type="hidden" ></TD>  </span></b></TD>
...
<table border="0" class="game_table all_body" cellpadding="0" cellspacing="0" style="width:780px;">
    <tr class="hset2">
        <td id="M_ConfirmClew" align="center" class="tbtitle" style="border:1px solid #bbafaf;border-top:none;width:778px;">
...
function beginrefresh(){
	 makeRequest('liuhecai.php?action=server&class1=正特&class2=<?=$ids?>');
}
</script>
