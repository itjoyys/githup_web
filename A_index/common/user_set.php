	...
	foreach ($level_set_data as $key => $val) {
		   ...
		   if(!empty($re_data)){
		      	switch ($val['fc_type_name']) {
			      	...
			      	case 'tj_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['tj_ssc'][$set_field] = $re_data;
			      		$sets['tj_ssc'][$set_field]['m_id'] = $re_data['id'];
			      		break;
			      	case 'xj_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['xj_ssc'][$set_field] = $re_data;
			      		$sets['xj_ssc'][$set_field]['m_id'] = $re_data['id'];
			      		break;
			      	case 'sh_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['sh_ssc'][$set_field] = $re_data;
			      		$sets['sh_ssc'][$set_field]['m_id'] = $re_data['id'];
			      		break;	
			      	case 'jx_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['jx_ssc'][$set_field] = $re_data;
			      		$sets['jx_ssc'][$set_field]['m_id'] = $re_data['id'];
			      		break;		
			      	case 'bj_8':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      	...
			      	case 'js_k3':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['js_k3'][$set_field] = $re_data;
			      		$sets['js_k3'][$set_field]['m_id'] = $re_data['id'];
			      		break;	
			      	case 'jl_k3':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['jl_k3'][$set_field] = $re_data;
			      		$sets['jl_k3'][$set_field]['m_id'] = $re_data['id'];
			      		break;		
		        ...
		        switch ($val['fc_type_name']) {
			      	...
			      	case 'sh_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['sh_ssc'][$set_field] = $val;
			      		break;
			      	case 'tj_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['tj_ssc'][$set_field] = $val;
			      		break;
			      	case 'xj_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['xj_ssc'][$set_field] = $val;
			      		break;
			      	case 'jx_ssc':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['jx_ssc'][$set_field] = $val;
			      		break;				
			      	case 'bj_8':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      	...
			      	case 'js_k3':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['js_k3'][$set_field] = $val;	
			      		break;	
			      	case 'jl_k3':
			      		$set_field = field_set_fc($val['fc_set_name']);
			      		$sets['jl_k3'][$set_field] = $val;
			      		break;	
