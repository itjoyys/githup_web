...
top.str_nodata = "您選擇的項目暫時沒有賽事。請修改您的選項或遲些再返回。"
top.str_waitdata = "数据加载中请稍等。。。"

//信用額度
top.str_maxcre = "僅能輸入數字!!";
top.str_checkkey = "僅能輸入數字!!";
...
top.str_pwd_limit = "您的密碼必須6至12個字元長,您只能使用數字和英文字母并至少 1 個英文字母,其他特殊符號不能使用 。";
top.str_pwd_limit1 = "安全代碼最少必須有2個英文大小寫字母和數字(0~9)組合輸入限制(6~12字元)";
...
top.str_safe_paswrd="安全代碼";
top.str_longinuser="登錄帳號";
