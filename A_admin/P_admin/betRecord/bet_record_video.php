...
<script>
    ...
    function GetVideoList(){
        var html='<tr><td colspan="14" align="center">数据加载中请等待...</td></tr>'
        $('#ListData').html(html);
        html='';
        ...
        $.post("../video/accountgetbetrecord.php?"+request,{},function(d){
            if(d['Error']){
                html+='<tr><td colspan="14"align="center">'+d['Error']+'</td></tr>'
            }
            else if(d['data']['Code']==10022){
                html+='<tr><td colspan="14" align="center">没有数据</td></tr>'
            }
            else if(d['data']['Code']==10006){
                html+='<tr><td colspan="14"align="center">此账号数据不存在</td></tr>'
            }
            else{
