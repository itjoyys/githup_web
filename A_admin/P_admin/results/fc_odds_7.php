...
$data=M("c_odds_4",$db_config)->limit("9")->select();
// p($data);
...
<body>
<div  id="con_wrap">
<div class="input_002">重慶快樂十分即時赔率</div>
<div class="con_menu">
        ...
        <option value="fc_odds_7.php" selected="selected">重慶快樂十分</option>
