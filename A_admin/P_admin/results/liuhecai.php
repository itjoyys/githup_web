...
$dat=M('c_auto_7',$db_config)->field("id")->where($map)->order("nn desc")->select();
...
//     $limit=$startCount.",".$perNumber;
    ...
    $data=M('c_auto_7',$db_config)->field("*")->where($map)->order("nn desc")->limit($limit)->select();
//p($data);
 ?>
