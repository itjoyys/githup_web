...
?>
 <?php $title="网球比赛结果"; require("../common_html/header.php");?>
        ...
        <tr>
          <td>
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="game">
              <tbody>
    <?php
	$sql		=	"SELECT ID,Match_ID,Match_Time,Match_Master,Match_Guest,Match_Name,MB_Inball,TG_Inball FROM tennis_match where match_js=1 and match_date='$page_date' order by Match_CoverDate,match_name,Match_Master desc";
	...
	while($rows	=	$query->fetch_array()){
	 ...
	 ?>
                ...
                <tr class="b_cen" id="TR_108_1817926" style="display:">
                  <td rowspan="3" class="time"><?=$rows["Match_Time"]?>
                  </td>
                ...
                <tr id="TR_1_108_1817926" style="display:" class="hr">
                  ...
                  <td class="hr_main_ft">
                    <span style="overflow:hidden;"> <?=$rows["MB_Inball_HR"]?>
     </span>
                  </td>
                  <td class="hr_main_ft">
                    <span style="overflow:hidden;"> <?=$rows["TG_Inball_HR"]?></span>
                  </td>
