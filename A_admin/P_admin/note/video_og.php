...
<script>
  ...
  <div  class="input_002">OG下注記錄</div>
  <div  class="con_menu">
	...
	日期：
    <input class="za_text Wdate"  value="" size="10" id="s_time" name="s_time" onClick="WdatePicker()"> 
	--
	 <input class="za_text Wdate"  value="" size="10" id="e_time" name="e_time" onClick="WdatePicker()"> 
