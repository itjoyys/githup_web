            ...
            <td width="100">
                <div  class="input_002"><?
                    ...
                    if($_GET['MacthType'] ){
                        ...
                        echo      $macth_name= $_GET['MacthType'].'-單节';
                    }
                    else{
                        $macth_name_="篮球$mach_type_name";
                        echo $macth_name="篮球$mach_type_name-單节";
                    }
                    ?></div>
            </td>
            <td width="150">
        ...
        <tr bgcolor="<?=$color?>" onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='<?=$color?>'">
            ...
            <td><table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr align="right">
                        ...
                        <td width="73%"><a href="list.php?match_id=<?=$rows["Match_ID"]?>&point_column=Match_DsDpl" <?=getAC($arr[$rows["Match_ID"]]["match_dsdpl"]['num'])?> ><?=getString($arr[$rows["Match_ID"]]["match_dsdpl"]['num'])?>/<?=getString($arr[$rows["Match_ID"]]["match_dsdpl"]['money'])?></a> </td>
                    </tr>
                    <tr align="right">
