...
if($save=='ok'){
	if($type<4){
		...
		$mysqli->query($sql);
		message("赔率修改完毕！","odds_6.php?type=".$type."");
		exit;
	}
	if($type==4){
		$sql	=	"update c_odds_6 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5'].",h6=".$_REQUEST['Num_6'].",h7=".$_REQUEST['Num_7']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds_6.php?type=".$type."");
		exit;
	}
	if($type==5){
		$sql	=	"update c_odds_6 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds_6.php?type=".$type."");
		exit;
	}
	if($type>5){
		$sql	=	"update c_odds_6 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5'].",h6=".$_REQUEST['Num_6'].",h7=".$_REQUEST['Num_7'].",h8=".$_REQUEST['Num_8'].",h9=".$_REQUEST['Num_9'].",h10=".$_REQUEST['Num_10']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds_6.php?type=".$type."");
		exit;
	}
...
//读取当前期数盘口赔率与投注总额
function loadinfo(){
	$.get("get_odds_6.php", {type : <?=$type?>}, function(data)
		{
...
<td><span class="lans"><a href="odds_1.php" style="color:#FFF" title="广东快乐十分赔率管理">广东快乐十分赔率</a></span><span class="lans"><a href="odds_2.php" style="color:#FFF" title="重庆时时彩赔率管理">重庆时时彩赔率</a></span><span class="lans"><a href="odds_4.php" style="color:#FFF" title="重庆快乐十分赔率管理">重庆快乐十分赔率</a></span><span class="lans"><a href="odds_3.php" style="color:#FFF" title="北京PK拾赔率管理">北京PK拾赔率</a></span><span class="lans"><a href="odds_5.php" style="color:#FFF" title="福彩3D">福彩3D</a></span><span class="hongs"><a href="odds_6.php" style="color:#FFF" title="排列三">排列三</a></span><span class="lans"><a href="odds_8.php" style="color:#FFF" title="北京快乐8">北京快乐8</a></span></td>       
    ...
    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#798EB9" style="margin-top:5px;">
      <tr>
        ...
        <a href="?type=7" style="color:<?=$se7?>; font-weight:bold; display:none;">独胆</a></td>
        </tr>   
    </table>
        <?php if($type<4){?>
