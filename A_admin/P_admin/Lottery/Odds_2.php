...
if($save=='ok'){
	if($type<6 || $type==10){
		$sql	=	"update c_odds_2 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5'].",h6=".$_REQUEST['Num_6'].",h7=".$_REQUEST['Num_7'].",h8=".$_REQUEST['Num_8'].",h9=".$_REQUEST['Num_9'].",h10=".$_REQUEST['Num_10'].",h11=".$_REQUEST['Num_11'].",h12=".$_REQUEST['Num_12'].",h13=".$_REQUEST['Num_13'].",h14=".$_REQUEST['Num_14'].",h15=".$_REQUEST['Num_15']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds_2.php?type=".$type."");
		exit;
	}
	if($type==6){
		$sql	=	"update c_odds_2 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5'].",h6=".$_REQUEST['Num_6'].",h7=".$_REQUEST['Num_7']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds_2.php?type=".$type."");
		exit;
	}
	if($type>6){
		$sql	=	"update c_odds_2 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds_2.php?type=".$type."");
		exit;
	}
...
//读取当前期数盘口赔率与投注总额
function loadinfo(){
	$.get("get_odds_2.php", {type : <?=$type?>}, function(data)
		{
...
function UpdateRate(num ,i){
	$.get("updaterate_2.php", {type : <?=$type?> ,num : num ,i : i}, function(data)
		{
  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="5">
    <tr>
      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font12">
        <tr>
<td><span class="lans"><a href="odds_1.php" style="color:#FFF" title="广东快乐十分赔率管理">广东快乐十分赔率</a></span><span class="hongs"><a href="odds_2.php" style="color:#FFF" title="重庆时时彩赔率管理">重庆时时彩赔率</a></span><span class="lans"><a href="odds_4.php" style="color:#FFF" title="重庆快乐十分赔率管理">重庆快乐十分赔率</a></span><span class="lans"><a href="odds_3.php" style="color:#FFF" title="北京PK拾赔率管理">北京PK拾赔率</a></span><span class="lans"><a href="odds_5.php" style="color:#FFF" title="福彩3D">福彩3D</a></span><span class="lans"><a href="odds_6.php" style="color:#FFF" title="排列三">排列三</a></span><span class="lans"><a href="odds_8.php" style="color:#FFF" title="北京快乐8">北京快乐8</a></span></td>       
 </tr>
      </table>
    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#798EB9" style="margin-top:5px;">
      <tr>
        ...
        <a href="?type=9" style="color:<?=$se9?>; font-weight:bold;">后三球</a>&nbsp;&nbsp;-&nbsp;&nbsp;
		<a href="?type=10" style="color:<?=$se10?>; font-weight:bold;">斗牛</a>&nbsp;&nbsp;-&nbsp;&nbsp;
		<a href="?type=11" style="color:<?=$se11?>; font-weight:bold;">梭哈</a>&nbsp;&nbsp;-&nbsp;&nbsp;</td>
        </tr>   
    </table>
        <?php if($type<6){?>
				...
				<?php }else if($type==7 || $type==8 || $type==9){?><table border="0"align="center" cellspacing="1" cellpadding="5" width="100%" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
                    <form name="form1" method="post" action="?type=<?=$type?>&save=ok">
                        <tr style="background-color:#3C4D82; color:#FFF">
                          <td width="50" height="22" align="center"><strong>号码</strong></td>
                          <td align="center"><strong>当前赔率</strong></td>
