...
foreach ($periods as $key => $value) {
  if($value['edate']>=date('Y-m-d',strtotime('-1 days')) && $value['sdate'] <= date('Y-m-d',strtotime('-1 days'))){
    $periods_now = $value;
  }
}
...
?>
<?php $title="历史报表"; require("../common_html/header.php");?>
...
if(range=='t' || range=='w' || range=='r'){
 FrmData.date_start.value ='<?=date("Y-m-d",strtotime("-1 day"))?>';
 FrmData.date_end.value =FrmData.date_start.value;}

if(range!='t'){
 if(FrmData.date_start.value!=FrmData.date_end.value){ FrmData.date_start.value ='<?=date("Y-m-d",strtotime("-1 day"))?>'; FrmData.date_end.value =FrmData.date_start.value;}
    ...
    <table width="650" border="0" cellspacing="1" cellpadding="0" class="m_tab">
      <tr class="m_cen">
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <td><input style="width:75px;" class="Wdate" name="date_start" type="text" id="date_start" value="<?=date("Y-m-d",strtotime("-1 day"))?>" onClick="WdatePicker()" size="10" maxlength="10" readonly /> </td>
            <td width="20" align="center">&nbsp;~&nbsp;</td>
            <td><input name="date_end" class="Wdate" style="width:75px;" type="text" id="date_end" value="<?=date("Y-m-d",strtotime("-1 day"))?>" onClick="WdatePicker()" size="10" maxlength="10" readonly /></td>
            <td>&nbsp;</td>
            <td>
            <input name="Submit" type="Button" class="za_button" onClick="chg_date('t',0,0)" value="今日">&nbsp;&nbsp;
              ...
              <input name="Submit" type="Button" class="za_button" onClick="FrmData.date_start.value='<?=$periods_now['sdate']?>';FrmData.date_end.value='<?=date("Y-m-d",strtotime("-1 day"))?>'" value="本期"></td>
          </tr>
        </table></td>
      </tr>
      <tr class="m_cen">
          ...
          <td colspan="3" style="text-align:left">
           <label><input type="checkbox" name="sp" class="game" checked="checked" id="zq" value="1">
            &nbsp;體育</label>&nbsp;
            <label><input type="checkbox" name="cp" class="game" id="cp" value="2">
            &nbsp;彩票</label>&nbsp;
            <label><input type="checkbox" name="mg" class="game" id="mg" value="7">
            &nbsp;MG视讯</label>&nbsp;
            <label><input type="checkbox" name="mgdz" class="game" id="mgdz" value="8">
            &nbsp;MG电子</label>&nbsp;
            <label><input type="checkbox" name="bbsx" class="game" id="bbsx" value="9">
            &nbsp;BBIN视讯</label>&nbsp;
            <label><input type="checkbox" name="bbdz" class="game" id="bbdz" value="12">
            &nbsp;BBIN机率</label>&nbsp;
            <label><input type="checkbox" name="bbty" class="game" id="bbty" value="13">
            &nbsp;BBIN球类</label>&nbsp;
            <label><input type="checkbox" name="bbcp" class="game" id="bbcp" value="14">
            &nbsp;BBIN彩票</label>&nbsp;
            <label><input type="checkbox" name="ag" class="game" id="ag" value="10">
            &nbsp;AG</label>&nbsp;
            <label><input type="checkbox" name="og" class="game" id="og" value="11">
            &nbsp;OG</label>&nbsp;
            <label> <input type="checkbox" name="lebo" class="game" id="lebo" value="3">
            &nbsp;LEBO</label>&nbsp;
            <label> <input type="checkbox" name="ct" class="game" id="ct" value="4">
            &nbsp;CT</label>&nbsp;
              </br>
