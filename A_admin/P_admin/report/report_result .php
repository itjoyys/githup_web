...
if($_GET['atype']!='user'){
	$agent = M('k_user_agent',$db_config)
		...
		->where("is_demo = '0' and is_delete = 0 and site_id = '".SITEID."'".$a_map)
		->select();
	...
	$agent_sh=$u
			...
			->where("shiwan = '0' and is_delete = 0 and site_id = '".SITEID."' and agent_id='".$_GET['uid']."'")
			->select();
}
//股东层
if($_GET['atype'] == 's_h'){
