...
$map = "k_user_cash_record.site_id = '".SITEID."' and k_user_cash_record.cash_date >= '".$start_date."' and k_user_cash_record.cash_date <= '".$end_date."' and k_user.shiwan = '0' and k_user_cash_record.agent_id = '".$_SESSION['agent_id']."'";
      ...
      <table  cellpadding="0" class="m_tab">
        ...
        <?php if (!empty($record)) {
          ...
          foreach ($record as $key => $val) {
            $count_c +=$val['cash_num']+$val['discount_num']+0;
            $totalCo += $count_c;
        ?>
...
";
        ...
        ?>
        <tr class="m_rig2"> 
          <td colspan="4" class="count_td" style="text-align: right;">小計</td>
          <td bgcolor="#CAE8EA" colspan="5" ><?=$count_c?></td> 
        </tr>
         <tr class="m_rig2"> 
          <td colspan="4" class="count_td" style="text-align: right;">总计</td>
