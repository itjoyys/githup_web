...
<head>
	...
	background: url(<?php echo ($images_url); ?>__PUBLICI__/interaction/images/scratch-card-bg.jpg);
    }
    </style>
</head>
                ...
                <div  class="box">
                    ...
                    <div  class="Detail">
                        ...
                        <P>这是您第 <SPAN class="red" id="usenums">0</SPAN> 次刮奖</P>
                           <?php if(is_array($prize_data)): $i = 0; $__LIST__ = $prize_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><P><?php echo ($v["level_name"]); ?>: <?php echo ($v["name"]); ?></P><?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <DIV class="boxcontent boxwhite">
                    <DIV class="box">
                        ...
                        <DIV class="Detail">
                           ...
                           <P>活动时间:<?php echo ($scratch_data['start']); ?>至<?php echo ($scratch_data['finish']); ?></P>
                           <P>兑奖请联系我们，电话138********</P>
                       </DIV>
                    </DIV>
               </DIV>
