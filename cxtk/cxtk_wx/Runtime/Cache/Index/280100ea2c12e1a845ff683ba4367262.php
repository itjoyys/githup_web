 ...
 <div class="top_bar">
	...
	<div class="main">
      ...
      <ul class="vertical-list">
          <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["type"] == 0): ?><li><a href="<?php echo U(GROUP_NAME . '/Website/web_list', array('id' => $v['id'],'type'=>'d'));?>" class='button' >♠<?php echo ($v["name"]); ?></a></li>
                   
                  <?php else: ?>
                      <li><a href="<?php echo U(GROUP_NAME . '/Website/web_list', array('id' => $v['id']));?>" class='button'>♠<?php echo ($v["name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
