...
<body>
    ...
    <div class="add_address">
       <div style="padding: 5px 15px 0;">
           <a class="buy" id="addcart" href="<?php echo U(GROUP_NAME . '/Shop/add_address');?>">添加收货地址</a>
       </div>
    </div> 
<!--地址列表-->
<div id="J_olist_plugin">
 <div class="mb-dti">    
   <?php if(is_array($address_d)): foreach($address_d as $key=>$v): ?><ul class="c-list"> 
        <li> 
            <label> 收货地址 </label> 
            <span class="c-ls-multi"><?php echo ($v["address_d"]); ?></span> 
        </li>
        <li> 
            <label> 收货人 </label> 
            ...
            <li> 
                <label> 手机号码 </label> 
                <span><a href="tel:1" class="c-ls-ar"><?php echo ($v["tel"]); ?></a>
                 <?php if($v["state"] == 1): ?>默认地址<?php endif; ?>
                </span>
            </li> 
                   <li> 
                <label> 操作 </label> 
                <span>
                    <?php if($v["state"] == 0): ?><a  href="#" nid ="<?php echo ($nid); ?>" aid = "<?php echo ($v["id"]); ?>" onclick="return false;" class="do_a do_address">设置默认地址</a><?php endif; ?>
                  <!--    <a class="do_a do_r" href="<?php echo U(GROUP_NAME . '/Shop/revise_address',array('id' => $v['id']));?>">编辑地址</a> -->
                     <a href="#" onclick="return false;"  aid = "<?php echo ($v["id"]); ?>" class="do_a do_d delete_address" >删除地址</a>
                </span>
            </li> 
