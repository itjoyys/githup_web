...
func bbin_game() {
	...
	m.Group("", func() {
		...
		m.Get("/updateallbalance", api.UpdateAllBalance)  //回调更新所有余额
		m.Get("/editaccountpwd", api.BBIN_EditAccountPwd) //修改密碼
...
func eg_game() {
	...
	m.Group("", func() {
		m.Get("/createaccount", api.Eg_CreateMember) //注册端口
		m.Get("/forwarddz", api.Eg_TransferGame)     //进入游戏页面

		m.Get("/getbetrecords", api.Eg_GetBetRecord)
		m.Get("/getavailableamountbyuser", api.Eg_GetAvailableAmountByUser)
		m.Get("/getavailableamountbysiteid", api.Eg_GetAvailableAmountBySiteid)
		m.Get("/getavailableamountbyagentid", api.Eg_GetAvailableAmountByAgentid)

		m.Get("/getuseravailableamountbyuser", api.Eg_GetUserAvailableAmountByUser)
		m.Get("/getuseravailableamountbysiteid", api.Eg_GetUserAvailableAmountBySiteid)
		m.Get("/getuseravailableamountbyagentid", api.Eg_GetUserAvailableAmountByAgentid)

		m.Get("/getagentavailableamountbyagentid", api.Eg_GetAgentAvailableAmountByAgentid)
