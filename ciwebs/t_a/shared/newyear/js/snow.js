...
$(function() {
	...
	function init() {
		...
		for (var i = 1; i <= imgNum; i++) {
			...
			particleImage.src = "/shared/newyear/images/snow"+i+".png";
			particleImages.push(particleImage);
		}
		for (var i = 1; i < snowNum; i++) {
			var particle = new Particle3D(new THREE.ParticleBasicMaterial({
				map: new THREE.Texture(particleImages[i%imgNum])
			}));
