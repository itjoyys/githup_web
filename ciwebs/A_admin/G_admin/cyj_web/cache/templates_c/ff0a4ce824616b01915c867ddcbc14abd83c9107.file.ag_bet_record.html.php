<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-11-10 13:29:59
         compiled from "D:\phpStudy\WWW\A_admin_ci\G_admin\cyj_web\views\note\video\ag_bet_record.html" */ ?>
<?php /*%%SmartyHeaderCode:2465564180d7ba1588-55732874%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff0a4ce824616b01915c867ddcbc14abd83c9107' => 
    array (
  ...
  'nocache_hash' => '2465564180d7ba1588-55732874',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_564180d7c64ab1_54129099',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_564180d7c64ab1_54129099')) {function content_564180d7c64ab1_54129099($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("web_header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
/note/Bet_record/video_bet_record?type=ag" style="color:#fff;">AG</a>
 				<a class="Company" href="<?php echo $_smarty_tpl->tpl_vars['site_url']->value;?>
...
?>
				<tr class="m_cen <?php if ($_smarty_tpl->tpl_vars['key']->value%2==0) {?>even<?php }?>">
					<td width="120" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['bet_time'];?>
</td>
					<td width="70" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['bill_no'];?>
</td>
					<td width="70" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['table_code'];?>
</td>
					...
					<td width="70" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['player_name'];?>
</td>
					<td width="70" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['login_ip'];?>
</td>
					<td width="70" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['before_credit'];?>
</td>
					<td width="90" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['bet_amount'];?>
</td>
					<td width="90" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['valid_betamount'];?>
</td>
					<td width="90" align="center">0</td>
					<td width="90" align="center"><?php echo $_smarty_tpl->tpl_vars['val']->value['netamount'];?>
</td>
				</tr>
