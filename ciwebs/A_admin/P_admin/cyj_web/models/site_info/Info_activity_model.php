...
class Info_activity_model extends MY_Model {
	...
	public function get_activity($pid,$index_id) {
		$data=$this->db->from('info_activity_edit_view')->where("state > 0 and pid = '".$pid."' and index_id= '". $index_id."' and site_id = '".$_SESSION['site_id']."'")->order_by('sort desc')->get()->result_array();
		return $data;
	}
