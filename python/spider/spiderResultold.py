...
if __name__ == '__main__':
    ...
    timec = time.strftime("%Y-%m-%d",  time.localtime(timenow))
    print timec
    try:
        rows=[
                [19,'/app/member/result/result.php?game_type=FT&langx=zh-cn&today='+str(timec)+'&uid='],
                [20, '/app/member/result/result.php?game_type=BK&langx=zh-cn&today='+str(timec)+'&uid='],
                [21, '/app/member/result/result_tn.php?game_type=TN&langx=zh-cn&today='+str(timec)+'&uid='],
                [22, '/app/member/result/result_vb.php?game_type=VB&langx=zh-cn&today='+str(timec)+'&uid='],
...
#              [24, '/app/member/result/result_tt.php?game_type=TT&langx=zh-cn&uid='],
                [25, '/app/member/result/result.php?game_type=BS&langx=zh-cn&today='+str(timec)+'&uid='],
