...
def BRbd1(title): 
    ...
    for ti in title:
        ...
        value ="'"+ti[0]+"','"+ti[1][0]+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[7]+"','"+text4+"','"+ti[8]+"','"+ti[9]+"','"+ti[10]+"','"+ti[11]+"','"+ti[12]+"','"+ti[13]+"','"+ti[14]+"','"+ti[15]+"','"+ti[16]+"','"+ti[17]+"','"+ti[18]+"','"+ti[19]+"','"+ti[20]+"','"+ti[21]+"','"+ti[22]+"','"+ti[23]+"','"+ti[24]+"','"+ti[25]+"','"+ti[26]+"','"+ti[27]+"','"+ti[28]+"','"+ti[29]+"','"+ti[30]+"','"+ti[31]+"','"+ti[32]+"','"+ti[33]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"',1,now(),1,"+'%d' %num4
...
def BRZRQ2(title): 
    ...
    for ti in title:
        ...
        text5 = text5+uptime
        text5 = time.strftime("%Y-%m-%d %H:%M:%S",  time.localtime(text5))
        value ="'"+ti[0]+"','"+ti[1][0]+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[7]+"','"+text4+"','"+ti[10]+"','"+ti[11]+"','"+ti[12]+"','"+ti[13]+"','"+ti[14]+"','"+ti[15]+"','"+ti[16]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"',1,now(),1,"+'%d' %num4
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_Total01Pl='"+ti[10]+"',Match_Total23Pl='"+ti[11]+"',Match_Total46Pl='"+ti[12]+"',Match_Total7upPl='"+ti[13]+"',Match_BzM='"+ti[14]+"',Match_BzG='"+ti[15]+"',Match_BzH='"+ti[16]+"',Match_Type=1,Match_LstTime=now() where Match_ID='"+ti[0]+"' AND Match_StopUpdatebd =0"
            print sql
            cur.execute(sql)
            num4+=1;                                                
    con.commit()
...
def BRBQC3(title): 
    ...
    for ti in title:
        ...
        text5 = text5+uptime
        text5 = time.strftime("%Y-%m-%d %H:%M:%S",  time.localtime(text5))
        value ="'"+ti[0]+"','"+ti[1][0]+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[7]+"','"+text4+"','"+ti[8]+"','"+ti[9]+"','"+ti[10]+"','"+ti[11]+"','"+ti[12]+"','"+ti[13]+"','"+ti[14]+"','"+ti[15]+"','"+ti[16]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"',1,now(),1,"+'%d' %num4
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_BqMM='"+ti[8]+"',Match_BqMH='"+ti[9]+"',Match_BqMG='"+ti[10]+"',Match_BqHM='"+ti[11]+"',Match_BqHH='"+ti[12]+"',Match_BqHG='"+ti[13]+"',Match_BqGM='"+ti[14]+"',Match_BqGH='"+ti[15]+"',Match_BqGG='"+ti[16]+"',Match_Type=1,Match_LstTime=now() where Match_ID='"+ti[0]+"' and Match_StopUpdatet =0 "
            print sql
            cur.execute(sql)
            num4+=1;                                                 
    con.commit()
...
def FUJR4(title): 
    ...
    for ti in title:
        ...
        text5 = text5+uptime
        text5 = time.strftime("%Y-%m-%d %H:%M:%S",  time.localtime(text5))
        value ="'"+ti[0]+"','"+ti[22]+"','"+ti[1][0]+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+text4+"',1,'"+ti[7]+"','"+ti[9]+"','"+ti[10]+"','"+ti[8]+"','"+ti[15]+"','"+ti[16]+"','"+ti[17]+"','"+ti[11]+"','"+ti[14]+"','"+ti[13]+"','"+ti[20]+"','"+ti[21]+"','"+ti[23]+"','"+ti[24]+"','"+ti[25]+"','"+ti[26]+"','"+ti[30]+"','"+ti[29]+"','"+ti[27]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"','"+ti[31]+"','"+ti[32]+"','"+ti[33]+"','"+ti[34]+"','"+ti[1][0]+" "+ti[1][1]+"',now(),1,"+'%d' %num4
...
#             Match_Date = ti[1][0][:-2]+str(Match_Date)  
        ...
        try:
            ...
            sql = "Update `lq_match` set Match_Ho='"+ti[9]+"',Match_Ao='"+ti[10]+"',Match_RGG='"+ti[8]+"',Match_DxGG='"+ti[11]+"',Match_DxDpl='"+ti[14]+"',Match_DxXpl='"+ti[13]+"',Match_DsDpl='"+ti[20]+"',Match_DsSpl='"+ti[21]+"',Match_LstTime=now() where Match_ID='"+ti[0]+"' "                                              
            print sql
            cur.execute(sql) 
            con.commit()
            num4+=1;                                                 
...
#             Match_Date = ti[1][0][:-2]+str(Match_Date) 
        ...
        ti[5] = ''.join(ti[5].split())
        ti[6] = ''.join(ti[6].split())
        value ="'"+ti[0]+"','"+Match_Date+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[3]+"','"+ti[4]+"','"+text4+"',1,'"+ti[9]+"','"+ti[10]+"','"+ti[8]+"','"+ti[15]+"','"+ti[16]+"','"+ti[11]+"','"+ti[14]+"','"+ti[13]+"','"+ti[20]+"','"+ti[21]+"','"+ti[7]+"','"+text5+"','"+ti[1][0]+" "+ti[1][1]+"'"
        ...
        try:
            cur.execute("insert into "+table+"(Match_ID,Match_Date,Match_Time,Match_Name,Match_Master,Match_Guest,Match_Masterid,Match_Guestid,Match_IsLose,Match_Type,Match_Ho,Match_Ao,Match_RGG,Match_BzM,Match_BzG,Match_DxGG,Match_DxDpl,Match_DxXpl,Match_DsDpl,Match_DsSpl,Match_ShowType,Match_CoverDate,Match_MatchTime) values ("+value+")")
            con.commit()
        except MySQLdb.Error, e:
...
#              [12,'http://w955.hg0088.com/app/member/browse_FS/reloadgame_R.php?mid=13390057&langx=zh-cn&choice=ALL&LegGame=ALL&pages=1&records=40&FStype=BK&area_id=&league_id=&rtype=fs&hot_game=&uid='],
               [13,'/app/member/TN_browse/body_var.php?rtype=r_all&langx=zh-cn&mtype=3&page_no=0&league_id=&hot_game=&uid='],
                [14,'/app/member/VB_browse/body_var.php?rtype=r_all&langx=zh-cn&mtype=3&page_no=0&league_id=&hot_game=&uid='],
...
#              [16,'http://w955.hg0088.com/app/member/TT_browse/body_var.php?rtype=r_all&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
               [17,'/app/member/BS_browse/body_var.php?rtype=r&langx=zh-cn&mtype=3&page_no=0&league_id=&uid='],
