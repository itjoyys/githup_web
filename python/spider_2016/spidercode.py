...
#             Match_Date = ti[1][0][:-2]+str(Match_Date)        
        ...
        value ="'"+ti[0]+"','"+Match_Date+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[7]+"','"+text4+"','"+ti[8]+"','"+ti[9]+"','"+ti[10]+"','"+ti[11]+"','"+ti[12]+"','"+ti[13]+"','"+ti[14]+"','"+ti[15]+"','"+ti[16]+"','"+ti[17]+"','"+ti[18]+"','"+ti[19]+"','"+ti[20]+"','"+ti[21]+"','"+ti[22]+"','"+ti[23]+"','"+ti[24]+"','"+ti[25]+"','"+ti[26]+"','"+ti[27]+"','"+ti[28]+"','"+ti[29]+"','"+ti[30]+"','"+ti[31]+"','"+ti[32]+"','"+ti[33]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"',1,now(),1,"+'%d' %num4
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_MatchTime='"+ti[1][0]+"',Match_CoverDate='"+text5+"',Match_Bd10='"+ti[8]+"',Match_ShowType='"+ti[7]+"',Match_Bd20='"+ti[9]+"',Match_Bd21='"+ti[10]+"',Match_Bd30='"+ti[11]+"',Match_Bd31='"+ti[12]+"',Match_Bd32='"+ti[13]+"',Match_Bd40='"+ti[14]+"',Match_Bd41='"+ti[15]+"',Match_Bd42='"+ti[16]+"',Match_Bd43='"+ti[17]+"',Match_Bd00='"+ti[18]+"',Match_Bd11='"+ti[19]+"',Match_Bd22='"+ti[20]+"',Match_Bd33='"+ti[21]+"',Match_Bd44='"+ti[22]+"',Match_Bdup5='"+ti[23]+"',Match_Bdg10='"+ti[24]+"',Match_Bdg20='"+ti[25]+"',Match_Bdg21='"+ti[26]+"',Match_Bdg30='"+ti[27]+"',Match_Bdg31='"+ti[28]+"',Match_Bdg32='"+ti[29]+"',Match_Bdg40='"+ti[30]+"',Match_Bdg41='"+ti[31]+"',Match_Bdg42='"+ti[32]+"',Match_Bdg43='"+ti[33]+"',Match_Type=1,Match_LstTime=now() where Match_ID='"+ti[0]+"' "
            cur.execute(sql)
            con.commit()
            num4+=1                                                  
    con.commit()
...
#             Match_Date = ti[1][0][:-2]+str(Match_Date)
        ...
        ti[5] = ''.join(ti[5].split())
        ti[6] = ''.join(ti[6].split())
        value ="'"+ti[0]+"','"+Match_Date+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[7]+"','"+text4+"','"+ti[10]+"','"+ti[11]+"','"+ti[12]+"','"+ti[13]+"','"+ti[14]+"','"+ti[15]+"','"+ti[16]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"',1,now(),1,"+'%d' %num4
        ...
        try:
            cur.execute("insert into `bet_match` ( Match_ID,Match_Date,Match_Time,Match_Name,Match_Master,Match_Guest,Match_ShowType,Match_IsLose,Match_Total01Pl,Match_Total23Pl,Match_Total46Pl,Match_Total7upPl,Match_CoverDate,Match_MasterID,Match_GuestID,Match_Type,Match_LstTime,iPage,iSn) values ("+value+")")
            con.commit()
        except MySQLdb.Error, e:
            sql = "Update `bet_match` set Match_MatchTime='"+ti[1][0]+"',Match_CoverDate='"+text5+"',Match_Total01Pl='"+ti[10]+"',Match_Total23Pl='"+ti[11]+"',Match_ShowType='"+ti[7]+"',Match_Total46Pl='"+ti[12]+"',Match_Total7upPl='"+ti[13]+"',Match_Type=1,Match_LstTime=now() where Match_ID='"+ti[0]+"' AND Match_StopUpdatebd =0"
            print sql
            cur.execute(sql)
            con.commit()
            num4+=1;                                                
...
#             Match_Date = ti[1][0][:-2]+str(Match_Date)
        ...
        ti[5] = ''.join(ti[5].split())
        ti[6] = ''.join(ti[6].split())
        value ="'"+ti[0]+"','"+Match_Date+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[7]+"','"+text4+"','"+ti[8]+"','"+ti[9]+"','"+ti[10]+"','"+ti[11]+"','"+ti[12]+"','"+ti[13]+"','"+ti[14]+"','"+ti[15]+"','"+ti[16]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"',1,now(),1,"+'%d' %num4
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_MatchTime='"+ti[1][0]+"',Match_CoverDate='"+text5+"',Match_BqMM='"+ti[8]+"',Match_BqMH='"+ti[9]+"',Match_ShowType='"+ti[7]+"',Match_BqMG='"+ti[10]+"',Match_BqHM='"+ti[11]+"',Match_BqHH='"+ti[12]+"',Match_BqHG='"+ti[13]+"',Match_BqGM='"+ti[14]+"',Match_BqGH='"+ti[15]+"',Match_BqGG='"+ti[16]+"',Match_Type=1,Match_LstTime=now() where Match_ID='"+ti[0]+"' and Match_StopUpdatet =0 "
            print sql
            cur.execute(sql)
            con.commit()
            num4+=1;                                                 
...
#             Match_Date = ti[1][0][:-2]+str(Match_Date)
        ...
        ti[5] = ''.join(ti[5].split())
        ti[6] = ''.join(ti[6].split())
        value ="'"+ti[0]+"','"+ti[22]+"','"+Match_Date+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+text4+"',1,'"+ti[7]+"','"+ti[9]+"','"+ti[10]+"','"+ti[8]+"','"+ti[15]+"','"+ti[16]+"','"+ti[17]+"','"+ti[11]+"','"+ti[14]+"','"+ti[13]+"','"+ti[20]+"','"+ti[21]+"','"+ti[23]+"','"+ti[24]+"','"+ti[25]+"','"+ti[26]+"','"+ti[30]+"','"+ti[29]+"','"+ti[27]+"','"+text5+"','"+ti[3]+"','"+ti[4]+"','"+ti[31]+"','"+ti[32]+"','"+ti[33]+"','"+ti[34]+"','"+ti[1][0]+" "+ti[1][1]+"',now(),1,"+'%d' %num4
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_MatchTime='"+ti[1][0]+"',Match_CoverDate='"+text5+"',Match_Ho='"+ti[9]+"',Match_ShowType='"+ti[7]+"',Match_Ao='"+ti[10]+"',Match_HalfId='"+ti[22]+"',Match_RGG='"+ti[8]+"',Match_BzM='"+ti[15]+"',Match_BzG='"+ti[16]+"',Match_BzH='"+ti[17]+"',Match_DxGG='"+ti[11]+"',Match_DxDpl='"+ti[14]+"',Match_DxXpl='"+ti[13]+"',Match_DsDpl='"+ti[20]+"',Match_DsSpl='"+ti[21]+"',Match_Hr_ShowType='"+ti[23]+"',Match_BRpk='"+ti[24]+"',Match_BHo='"+ti[25]+"',Match_BAo='"+ti[26]+"',Match_Bdpl='"+ti[30]+"',Match_Bxpl='"+ti[29]+"',Match_BDxpk='"+ti[27]+"',Match_Bmdy='"+ti[31]+"',Match_Bgdy='"+ti[32]+"',Match_Bhdy='"+ti[33]+"',Match_TypePlay='"+ti[34]+"',Match_Type=1,Match_LstTime=now() where Match_ID='"+ti[0]+"' and Match_StopUpdatebq=0"
            #print sql
            cur.execute(sql) 
            con.commit()
            num4+=1;
...
def BRbd5(title): 
    ...
    for ti in title:
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_Bd10='"+ti[8]+"',Match_Bd20='"+ti[9]+"',Match_Bd21='"+ti[10]+"',Match_Bd30='"+ti[11]+"',Match_Bd31='"+ti[12]+"',Match_Bd32='"+ti[13]+"',Match_Bd40='"+ti[14]+"',Match_Bd41='"+ti[15]+"',Match_Bd42='"+ti[16]+"',Match_Bd43='"+ti[17]+"',Match_Bd00='"+ti[18]+"',Match_Bd11='"+ti[19]+"',Match_Bd22='"+ti[20]+"',Match_Bd33='"+ti[21]+"',Match_Bd44='"+ti[22]+"',Match_Bdup5='"+ti[23]+"',Match_Bdg10='"+ti[24]+"',Match_Bdg20='"+ti[25]+"',Match_Bdg21='"+ti[26]+"',Match_Bdg30='"+ti[27]+"',Match_Bdg31='"+ti[28]+"',Match_Bdg32='"+ti[29]+"',Match_Bdg40='"+ti[30]+"',Match_Bdg41='"+ti[31]+"',Match_Bdg42='"+ti[32]+"',Match_Bdg43='"+ti[33]+"',Match_Type=0,Match_LstTime=now() where Match_ID='"+ti[0]+"' "
            cur.execute(sql)
            con.commit()
            num4+=1                                                  
    con.commit()
...
def BRZRQ6(title): 
    ...
    for ti in title:
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_Total01Pl='"+ti[10]+"',Match_Total23Pl='"+ti[11]+"',Match_Total46Pl='"+ti[12]+"',Match_Total7upPl='"+ti[13]+"',Match_BzM='"+ti[14]+"',Match_BzG='"+ti[15]+"',Match_BzH='"+ti[16]+"',Match_Type=0,Match_LstTime=now() where Match_ID='"+ti[0]+"' and Match_StopUpdatebd =0"
            print sql
            cur.execute(sql)
            num4+=1;                                                
    con.commit()
...
def BRBQC7(title): 
    ...
    for ti in title:
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_BqMM='"+ti[8]+"',Match_BqMH='"+ti[9]+"',Match_BqMG='"+ti[10]+"',Match_BqHM='"+ti[11]+"',Match_BqHH='"+ti[12]+"',Match_BqHG='"+ti[13]+"',Match_BqGM='"+ti[14]+"',Match_BqGH='"+ti[15]+"',Match_BqGG='"+ti[16]+"',Match_Type=0,Match_LstTime=now() where Match_ID='"+ti[0]+"' and Match_StopUpdatet =0"
            print sql
            cur.execute(sql)
            num4+=1;                                                 
    con.commit()
...
def FUJR8(title): 
    ...
    for ti in title:
        ...
        try:
            ...
            sql = "Update `bet_match` set Match_Ho='"+ti[9]+"',Match_Ao='"+ti[10]+"',Match_RGG='"+ti[8]+"',Match_BzM='"+ti[15]+"',Match_BzG='"+ti[16]+"',Match_BzH='"+ti[17]+"',Match_DxGG='"+ti[11]+"',Match_DxDpl='"+ti[14]+"',Match_DxXpl='"+ti[13]+"',Match_DsDpl='"+ti[20]+"',Match_DsSpl='"+ti[21]+"',Match_Hr_ShowType='"+ti[23]+"',Match_BRpk='"+ti[24]+"',Match_BHo='"+ti[25]+"',Match_BAo='"+ti[26]+"',Match_Bdpl='"+ti[30]+"',Match_Bxpl='"+ti[29]+"',Match_BDxpk='"+ti[27]+"',Match_Bmdy='"+ti[31]+"',Match_Bgdy='"+ti[32]+"',Match_Bhdy='"+ti[33]+"',Match_TypePlay='"+ti[34]+"',Match_Type=0,Match_LstTime=now() where Match_ID='"+ti[0]+"' and Match_StopUpdatebq=0"                                              
            print sql
            cur.execute(sql) 
            num4+=1;                                                 
    con.commit()
...
def BKRMAIN9(title): 
    ...
    for ti in title:
        ...
        try:
            ...
            sql = "Update `lq_match` set Match_MatchTime='"+ti[1][0]+"',Match_CoverDate='"+text5+"',Match_ShowType='"+ti[7]+"',Match_Ho='"+ti[9]+"',Match_Ao='"+ti[10]+"',Match_RGG='"+ti[8]+"',Match_DxGG='"+ti[11]+"',Match_DxDpl='"+ti[14]+"',Match_DxXpl='"+ti[13]+"',Match_DsDpl='"+ti[20]+"',Match_DsSpl='"+ti[21]+"',Match_LstTime=now() where Match_ID='"+ti[0]+"' "                                              
            print sql
            cur.execute(sql) 
            con.commit()
            num4+=1;                                                 
...
#             Match_Date = ti[1][0][:-2]+str(Match_Date)  
        ...
        value ="'"+ti[0]+"','"+Match_Date+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+text4+"',1,'"+ti[7]+"','"+ti[9]+"','"+ti[10]+"','"+ti[8]+"','"+ti[11]+"','"+ti[14]+"','"+ti[13]+"','"+ti[20]+"','"+ti[21]+"','"+text5+"','"+ti[1][0]+" "+ti[1][1]+"','"+ti[3]+"','"+ti[4]+"',now(),1,"+'%d' %num4
        print "insert into lq_match(Match_ID,Match_Date,Match_Time,Match_Name,Match_Master,Match_Guest,Match_IsLose,Match_Type,Match_ShowType,Match_Ho,Match_Ao,Match_RGG,Match_DxGG,Match_DxDpl,Match_DxXpl,Match_DsDpl,Match_DsSpl,Match_CoverDate,Match_MatchTime,Match_MasterID,Match_GuestID,Match_LstTime,iPage,iSn) values ("+value+")"
        try:
            cur.execute("insert into lq_match(Match_ID,Match_Date,Match_Time,Match_Name,Match_Master,Match_Guest,Match_IsLose,Match_Type,Match_ShowType,Match_Ho,Match_Ao,Match_RGG,Match_DxGG,Match_DxDpl,Match_DxXpl,Match_DsDpl,Match_DsSpl,Match_CoverDate,Match_MatchTime,Match_MasterID,Match_GuestID,Match_LstTime,iPage,iSn) values ("+value+")")
        except MySQLdb.Error, e:
            sql = "Update `lq_match` set Match_Type = 1,Match_MatchTime='"+ti[1][0]+"',Match_CoverDate='"+text5+"',Match_ShowType='"+ti[7]+"',Match_Ho='"+ti[9]+"',Match_Ao='"+ti[10]+"',Match_RGG='"+ti[8]+"',Match_DxGG='"+ti[11]+"',Match_DxDpl='"+ti[14]+"',Match_DxXpl='"+ti[13]+"',Match_DsDpl='"+ti[20]+"',Match_DsSpl='"+ti[21]+"',Match_LstTime=now() where Match_ID='"+ti[0]+"' "
            print sql
            cur.execute(sql) 
            num4+=1;                                                 
    con.commit()
...
def TNBRO13(title,table): 
    ...
    for ti in title:
        ...
        ti[10] = ''.join(ti[10].split())
        ti[8] = ''.join(ti[8].split()) 
        value ="'"+ti[0]+"','"+ti[1][0]+"','"+ti[1][1]+"','"+ti[2]+"','"+ti[5]+"','"+ti[6]+"','"+ti[3]+"','"+ti[4]+"','"+text4+"',1,'"+ti[9]+"','"+ti[10]+"','"+ti[8]+"','"+ti[15]+"','"+ti[16]+"','"+ti[11]+"','"+ti[14]+"','"+ti[13]+"','"+ti[20]+"','"+ti[21]+"','"+ti[7]+"','"+text5+"','"+ti[1][0]+" "+ti[1][1]+"'"
...
operator = {1:FUJR4,2:BRbd1,3:BRZRQ2,4:BRBQC3,5:FUJR8,6:BRbd5,7:BRZRQ6,8:BRBQC7,9:BKRMAIN9,11:BKRMAIN11,13:TNBRO13,14:TNBRO13,17:TNBRO13,19:BKRMAIN11}
...
if __name__ == '__main__':
    ...
    try:
        rows=[
                 [1,'/app/member/FT_browse/body_var.php?rtype=r&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
                 [2,'/app/member/FT_browse/body_var.php?rtype=pd&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
                 [3,'/app/member/FT_browse/body_var.php?rtype=t&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
                 [4,'/app/member/FT_browse/body_var.php?rtype=f&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
                 [19,'/app/member/BK_browse/body_var.php?rtype=r_all&langx=zh-cn&mtype=3&page_no=0&league_id=&hot_game=&uid='],
...
#                [9,'/app/member/BK_browse/body_var.php?rtype=r_main&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
# #              [10,'http://w955.hg0088.com/app/member/browse_FS/reloadgame_R.php?mid=13390057&langx=zh-cn&choice=ALL&LegGame=ALL&pages=1&records=40&FStype=BK&area_id=&league_id=&rtype=fs&hot_game=&uid='],
#                [11,'/app/member/BK_future/body_var.php?rtype=r_main&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&g_date=&uid='],
# #              [12,'http://w955.hg0088.com/app/member/browse_FS/reloadgame_R.php?mid=13390057&langx=zh-cn&choice=ALL&LegGame=ALL&pages=1&records=40&FStype=BK&area_id=&league_id=&rtype=fs&hot_game=&uid='],
#                [13,'/app/member/TN_browse/body_var.php?rtype=r_all&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
#                [14,'/app/member/VB_browse/body_var.php?rtype=r&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
# #              [15,'http://w955.hg0088.com/app/member/BM_browse/body_var.php?rtype=r_all&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
# #              [16,'http://w955.hg0088.com/app/member/TT_browse/body_var.php?rtype=r_all&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
#                [17,'/app/member/BS_browse/body_var.php?rtype=r&langx=zh-cn&mtype=4&page_no=0&league_id=&uid='],
# #              [18,'http://w955.hg0088.com/app/member/OP_browse/body_var.php?rtype=r&langx=zh-cn&mtype=4&page_no=0&league_id=&hot_game=&uid='],
             ]
        for row in rows:
            # print row
